locals{
    ...
    dns_txt = "v=spf1 include:spf.protection.outlook.com include:emaileuc.freshservice.com \"\"include:spf-0055bf01.pphosted.com include:_spf.salesforce.com include:mg-spf.greenhouse.io include:aspmx.pardot.com -all"
